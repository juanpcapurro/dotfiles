...
config.downloads.location.prompt = False
config.tabs.background = True
config.auto_save.session = True

# editor setting
config.editor.command = ["st", "-t", "i3_dropdown_quteditor","nvim", "-f", "{file}", "-c", "normal {line}G{column0}1"]
